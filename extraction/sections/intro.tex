...
BlanchetteEtAl2016}, a hammer translation is \emph{sound} when provability
of the translated goal from the translated premises does not outrun the
source: it must be impossible to translate a consistent development and
obtain a first-order theory from which the image of a false --- or
refutable --- goal is derivable.  (The converse property, that provable
